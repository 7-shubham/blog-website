...
app.get("/" , function(req , res){
     ...
     res.render("home.ejs" , {homePara:homeStartingContent , posts:posts});
...
app.get("/posts/:postName" , function(req , res){
    ...
    const op = _.lowerCase(req.params.postName);

    posts.forEach(function(post){

     const op1 = _.lowerCase(post.title);
